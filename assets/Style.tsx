...
export class ColorScheme {
  ...
  styles = StyleSheet.create({
    headerText:{
      backgroundColor: this.colors['--background-tertiary'],
      color: this.colors['--foreground-default'],
    },
    ...
    modalView: {
      margin: 20,
      backgroundColor: this.colors['--background-default'],
      borderRadius: 7,
      padding: 35,
      alignItems: "center",
      shadowColor: "#000",
    ...
    smallText: {
      color: this.colors['--foreground-tertiary'],
      fontSize: 9,
    },
    lessNormalText: {
    ...
    mview: {
      backgroundColor: this.colors['--background-secondary'],
      color: this.colors['--foreground-default'],
      flex: 1,
      alignItems: 'center',
      justifyContent: 'center',
    ...
    drawerHeaderTitleStyle: {
      color: this.colors['--foreground-secondary'],
      fontWeight: 'bold',
      padding: 10,
      fontSize:18,
    },
    ...
    footerViewStyle: {
      borderStyle: 'solid',
      borderWidth: 2,
      borderTopColor: this.colors['--foreground-light'],
      borderBottomColor: this.colors['--background-secondary'],
      borderLeftColor: this.colors['--background-secondary'],
      borderRightColor: this.colors['--background-secondary'],
      // borderRadius:8,
    },
    footerContent: {
      fontSize: 20,
    ...
    loginInput:{
      height: 40,
      borderColor: this.colors['--foreground-tertiary'],
      borderBottomWidth: 1,
      marginBottom: 36
    },
    btnContainer: {
      color: this.colors['--background-light'],
      marginTop: 12,
    },
